...
class AnswerSerializer(serializers.ModelSerializer):
    ...
    def get_is_verified(self, obj):
        ...
        return obj.question.verified_answer_id == obj.id
...
class QuestionSerializer(serializers.ModelSerializer):
    ...
    verified_answer = AnswerSerializer(read_only=True)
...
# =============================================================================
# ANSWER VERIFICATION SERIALIZERS (Simplified)
# =============================================================================

class VerifyAnswerRequestSerializer(serializers.Serializer):
    """Serializer for verifying an answer"""
    answer_id = serializers.UUIDField(required=True)


class VerifyAnswerResponseSerializer(serializers.Serializer):
    """Serializer for verify answer response"""
    success = serializers.BooleanField()
    message = serializers.CharField()
    verified_answer_id = serializers.UUIDField(required=False, allow_null=True)


# =============================================================================
# VECTOR SEARCH SERIALIZERS (Keep existing)
# =============================================================================
